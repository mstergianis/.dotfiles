...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default nil)
   dotspacemacs-initial-scratch-message ";; This is your scratch buffer, run elisp commands here"
...
you should place your code here."
  ...
  ;;                                  ("||" . ?∨)
  ;;                                  ("not" . ?¬))))
  (dolist (m '(web-mode-hook js2-mode-hook typescript-mode-hook go-mode-hook emacs-lisp-mode lisp-interaction-mode))
    (add-hook m #'prettify-symbols-mode)
  ...
  (defvar magit-duet--default-commit-popup-actions nil
    "Store the magit-commit-popup here for de-initializing. magit-duet-commit")
  ...
  (defun magit-duet-commit-init ()
    ...
    (when (eq magit-duet--default-commit-popup-actions nil)
      (progn
        ...
        (transient-append-suffix 'magit-commit "c"
          '("D" "Duet" magit-duet-duet))

        (transient-append-suffix 'magit-commit "c"
          '("s" "Solo" magit-duet-solo))
        )
      ))

  (add-hook 'magit-mode-hook 'magit-duet-commit-init)
  (evil-define-key nil evil-normal-state-map (kbd "C-o") 'pop-tag-mark)
  (evil-define-key nil evil-motion-state-map (kbd "C-o") 'pop-tag-mark)

  (add-hook 'typescript-tsx-mode (lambda () (setq-local indent-region-function #'web-mode-indent-line)))
  ...
  (use-package lsp-tailwindcss
    ...
    :config
    (setq lsp-tailwindcss-validate nil
...
(defun customize-yaml-mode ()
  (add-hook 'yaml-mode-hook #'add-node-modules-path)
  (add-hook 'yaml-mode-hook
            (lambda ()
              (add-hook 'after-save-hook #'prettier-js nil 't))))
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(add-node-modules-path-debug nil)
   '(dap-print-io t)
   ...
   '(lsp-eslint-experimental nil)
   '(lsp-eslint-options nil)
